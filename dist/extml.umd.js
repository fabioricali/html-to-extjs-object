/* Extml, version: 2.1.18 - November 2, 2024 20:49:39 */
...
}const n = function (t, s, r, e) {
    var u;
    s[0] = 0;
    for (var h = 1; h < s.length; h++) {
        var p = s[h++], a = s[h] ? (s[0] |= p ? 1 : 2, r[s[h++]]) : s[++h];
        3 === p ? e[0] = a : 4 === p ? e[1] = Object.assign(e[1] || {}, a) : 5 === p ? (e[1] = e[1] || {})[s[++h]] = a : 6 === p
            ? typeof a === "function" && a.$$isState
                ? (++h, Array.isArray(e[1][s[h]]) ? e[1][s[h]].push(a) : (e[1][s[h]] = [e[1][s[h]], a]))
                : (e[1][s[h]] += (a + ''))
            : p ? (u = t.apply(a, n(t, a, r, ["", null])), e.push(u), a[0] ? s[0] |= 2 : (s[h - 2] = 0, s[h] = u)) : e.push(a);
    }
    return e
}, t = new Map;
